...
#Region " Routines "
    ...
    Friend Function ReSetBit(ByVal Word As Integer, ByVal Bit As Integer, _
        ...
        '09/05/14   MSW     Revised change from inovision. to return signed 16 bit values
        '********************************************************************************************
        ...
        If b32Bit Then
            ...
            Else
                ReSetBit = Word And &H7FFFFFFF
            End If
        Else
            '16 bit
            Word = Word And &HFFFF
            If Bit < 16 Then
                ReSetBit = Word And (Not CInt(2 ^ Bit) And &HFFFF)
            Else
                ReSetBit = Word
            End If
            If ReSetBit > 32767 Then
                ReSetBit = ReSetBit - 65536
            End If
        End If
    ...
    Friend Function SetBit(ByVal Word As Integer, ByVal Bit As Integer, _
        ...
        If b32Bit Then
            ...
            Else
                SetBit = Word Or &H80000000  'CInt(Word Or (CInt(2 ^ Bit) - 4294967296))  '100000000000000000000000000000000
            End If
        Else '16 bit
            Word = Word And &HFFFF
            If Bit < 16 Then
