...
'    07/30/14   MSW     2nd group support for dualcan                                 4.01.07.01
'********************************************************************************************
...
Public Class uctrlVersabell3
    ...
    Private mnGroup2ValveStates As Integer = 0
    ...
    Private Sub UctrlGroupValve_Click(ByVal sender As Object) Handles UctrlGroupValve0.ValveClick, UctrlGroupValve1.ValveClick, UctrlGroupValve2.ValveClick, UctrlGroupValve3.ValveClick, _
        ...
        UctrlGroupValve26.ValveClick, UctrlGroupValve27.ValveClick, _
    ...
    ' Date      By      Reason
    '********************************************************************************************
    Property Group2ValveStates() As Integer Implements CCToonUctrl.Group2ValveStates
        Get
            Return mnGroup2ValveStates
        End Get
        Set(ByVal value As Integer)
            mnGroup2ValveStates = value
        End Set
    End Property
    '********************************************************************************************
